...
function DashboardComponent_div_78_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(ctx_r2.totalLists);
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate(ctx_r2.itemsToBuy);
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate(ctx_r2.itemsBought);
    \u0275\u0275advance(10);
...
function DashboardComponent_div_79_mat_card_4_p_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const list_r5 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
...
function DashboardComponent_div_79_mat_card_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275styleProp("background-image", "url(" + (list_r5.img || "https://images.pexels.com/photos/1132047/pexels-photo-1132047.jpeg") + ")");
    \u0275\u0275advance(3);
...
var _DashboardComponent = class _DashboardComponent {
  ...
  get itemsToBuy() {
    return this.lists$.value.reduce((count, list) => count + list.items.filter((item) => item.status === "to_buy").length, 0);
  }
  get itemsBought() {
    return this.lists$.value.reduce((count, list) => count + list.items.filter((item) => item.status === "bought").length, 0);
  }
  get totalItems() {
...
_DashboardComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardComponent, selectors: [["app-dashboard"]], decls: 81, vars: 22, consts: [["userMenu", "matMenu"], ["sidenav", ""], [1, "dashboard-container"], ["color", "primary", 1, "app-toolbar"], ["mat-icon-button", "", 1, "menu-button", 3, "click"], [1, "app-title"], [1, "spacer"], ["mat-button", "", 1, "new-list-button", 3, "routerLink"], ["mat-icon-button", "", 1, "user-button", 3, "matMenuTriggerFor"], [1, "user-avatar", 3, "src", "alt"], [1, "user-info"], [1, "user-avatar-large", 3, "src", "alt"], [1, "user-name"], [1, "user-email"], ["mat-menu-item", "", 3, "click"], [1, "sidenav-container"], ["mode", "side", "opened", "", 1, "sidenav"], ["mat-list-item", "", "routerLinkActive", "active", 3, "routerLink"], ["matListItemIcon", ""], ["matListItemTitle", ""], ["matSubheader", ""], ["matListItemMeta", "", 1, "stat-badge"], [1, "main-content"], [1, "content-container"], [1, "welcome-section"], [1, "page-title"], [1, "page-subtitle"], ["class", "stats-grid", 4, "ngIf"], ["class", "recent-lists-section", 4, "ngIf"], ["class", "loading-container", 4, "ngIf"], [1, "stats-grid"], [1, "stat-card"], [1, "stat-content"], [1, "stat-icon", "primary"], [1, "stat-number"], [1, "stat-label"], [1, "stat-icon", "accent"], [1, "stat-icon", "success"], [1, "stat-icon", "info"], [1, "recent-lists-section"], [1, "section-title"], [1, "lists-grid"], ["class", "list-card", 3, "click", 4, "ngFor", "ngForOf"], ["class", "no-lists", 4, "ngIf"], [1, "list-card", 3, "click"], [1, "list-image"], [1, "list-overlay"], [1, "list-title"], ["class", "list-comment", 4, "ngIf"], [1, "list-stats"], ["aria-label", "List statistics"], [3, "disabled"], [3, "disabled", 4, "ngIf"], ["mat-button", "", "color", "primary", 3, "click"], ["mat-button", "", 3, "click"], [1, "list-comment"], [1, "no-lists"], [1, "empty-icon"], ["mat-raised-button", "", "color", "primary", 3, "routerLink"], [1, "loading-container"], ["diameter", "50"]], template: /* @__PURE__ */ __name(function DashboardComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(36, "Dashboard");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(37, "a", 17)(38, "mat-icon", 18);
    \u0275\u0275text(39, "list");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("src", (ctx.currentUser == null ? null : ctx.currentUser.photoURL) || "https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg", \u0275\u0275sanitizeUrl)("alt", (ctx.currentUser == null ? null : ctx.currentUser.displayName) || "User");
    \u0275\u0275advance(4);
    \u0275\u0275property("src", (ctx.currentUser == null ? null : ctx.currentUser.photoURL) || "https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg", \u0275\u0275sanitizeUrl)("alt", (ctx.currentUser == null ? null : ctx.currentUser.displayName) || "User");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate((ctx.currentUser == null ? null : ctx.currentUser.displayName) || "User");
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(ctx.itemsToBuy);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(ctx.itemsBought);
    \u0275\u0275advance(5);
...
(() => {
  ...
  `, styles: ["/* angular:styles/component:css;16afb440de003ea66be71a09edd551b0abcff89785882ce630ed270ac863221a;C:/dev/kontys/listok/listok-bolt/src/app/components/dashboard/dashboard.component.ts */\n.dashboard-container {\n  height: 100vh;\n  display: flex;\n  flex-direction: column;\n}\n.app-toolbar {\n  position: sticky;\n  top: 0;\n  z-index: 2;\n}\n.app-title {\n  font-size: 20px;\n  font-weight: 600;\n}\n.spacer {\n  flex: 1 1 auto;\n}\n.new-list-button {\n  margin-right: 16px;\n}\n.user-button {\n  padding: 4px;\n}\n.user-avatar {\n  width: 32px;\n  height: 32px;\n  border-radius: 50%;\n  object-fit: cover;\n}\n.user-avatar-large {\n  width: 48px;\n  height: 48px;\n  border-radius: 50%;\n  object-fit: cover;\n}\n.user-info {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  padding: 16px;\n}\n.user-name {\n  font-weight: 600;\n  margin: 0;\n}\n.user-email {\n  font-size: 14px;\n  opacity: 0.7;\n  margin: 0;\n}\n.sidenav-container {\n  flex: 1;\n}\n.sidenav {\n  width: 280px;\n  padding: 0;\n}\n.sidenav mat-nav-list {\n  padding-top: 0;\n}\n.sidenav a.active {\n  background-color: rgba(0, 0, 0, 0.04);\n}\n.stat-badge {\n  background-color: #1976d2;\n  color: white;\n  padding: 4px 8px;\n  border-radius: 12px;\n  font-size: 12px;\n  font-weight: 600;\n}\n.main-content {\n  background-color: #fafafa;\n}\n.content-container {\n  padding: 24px;\n  max-width: 1200px;\n  margin: 0 auto;\n}\n.welcome-section {\n  margin-bottom: 32px;\n}\n.page-title {\n  font-size: 32px;\n  font-weight: 600;\n  margin: 0 0 8px 0;\n  color: #1976d2;\n}\n.page-subtitle {\n  font-size: 16px;\n  opacity: 0.7;\n  margin: 0;\n}\n.stats-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));\n  gap: 16px;\n  margin-bottom: 32px;\n}\n.stat-card {\n  border-radius: 12px;\n  transition: transform 0.2s, box-shadow 0.2s;\n}\n.stat-card:hover {\n  transform: translateY(-2px);\n  box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);\n}\n.stat-content {\n  display: flex;\n  align-items: center;\n  gap: 16px;\n}\n.stat-icon {\n  font-size: 40px;\n  width: 40px;\n  height: 40px;\n  border-radius: 8px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.stat-icon.primary {\n  background-color: #e3f2fd;\n  color: #1976d2;\n}\n.stat-icon.accent {\n  background-color: #fff3e0;\n  color: #f57c00;\n}\n.stat-icon.success {\n  background-color: #e8f5e8;\n  color: #4caf50;\n}\n.stat-icon.info {\n  background-color: #f3e5f5;\n  color: #9c27b0;\n}\n.stat-number {\n  font-size: 28px;\n  font-weight: 700;\n  margin: 0;\n  color: #333;\n}\n.stat-label {\n  font-size: 14px;\n  opacity: 0.7;\n  margin: 0;\n}\n.section-title {\n  font-size: 24px;\n  font-weight: 600;\n  margin: 0 0 16px 0;\n  color: #333;\n}\n.lists-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(300px, 1fr));\n  gap: 20px;\n}\n.list-card {\n  border-radius: 12px;\n  overflow: hidden;\n  transition: transform 0.2s, box-shadow 0.2s;\n  cursor: pointer;\n}\n.list-card:hover {\n  transform: translateY(-4px);\n  box-shadow: 0 8px 25px rgba(0, 0, 0, 0.15);\n}\n.list-image {\n  height: 160px;\n  background-size: cover;\n  background-position: center;\n  position: relative;\n}\n.list-overlay {\n  position: absolute;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  background: linear-gradient(transparent, rgba(0, 0, 0, 0.7));\n  color: white;\n  padding: 16px;\n}\n.list-title {\n  font-size: 18px;\n  font-weight: 600;\n  margin: 0;\n}\n.list-comment {\n  font-size: 14px;\n  opacity: 0.7;\n  margin: 0 0 12px 0;\n  line-height: 1.4;\n}\n.list-stats {\n  margin-bottom: 8px;\n}\n.list-stats mat-chip-set {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 4px;\n}\n.list-stats mat-chip {\n  font-size: 12px;\n}\n.no-lists {\n  text-align: center;\n  padding: 40px;\n  background-color: white;\n  border-radius: 12px;\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);\n}\n.empty-icon {\n  font-size: 64px;\n  width: 64px;\n  height: 64px;\n  opacity: 0.3;\n  margin-bottom: 16px;\n}\n.no-lists h3 {\n  margin: 0 0 8px 0;\n  font-size: 20px;\n}\n.no-lists p {\n  margin: 0 0 24px 0;\n  opacity: 0.7;\n}\n.loading-container {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  padding: 40px;\n  gap: 16px;\n}\n@media (max-width: 768px) {\n  .sidenav {\n    width: 240px;\n  }\n  .content-container {\n    padding: 16px;\n  }\n  .page-title {\n    font-size: 24px;\n  }\n  .stats-grid {\n    grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));\n    gap: 12px;\n  }\n  .lists-grid {\n    grid-template-columns: 1fr;\n    gap: 16px;\n  }\n}\n/*# sourceMappingURL=dashboard.component.css.map */\n"] }]
...
//# sourceMappingURL=dashboard.component-OQA2HRA4.js.map
