...
(() => {
  ...
  `, styles: ["/* angular:styles/component:scss;16afb440de003ea66be71a09edd551b0abcff89785882ce630ed270ac863221a;/home/runner/work/listok-bolt/listok-bolt/src/app/components/dashboard/dashboard.component.ts */\n.dashboard-container {\n  height: 100vh;\n  display: flex;\n  flex-direction: column;\n}\n.app-toolbar {\n  position: sticky;\n  top: 0;\n  z-index: 2;\n}\n.app-title {\n  font-size: 20px;\n  font-weight: 600;\n}\n.spacer {\n  flex: 1 1 auto;\n}\n.new-list-button {\n  margin-right: 16px;\n}\n.user-button {\n  padding: 4px;\n}\n.user-avatar {\n  width: 32px;\n  height: 32px;\n  border-radius: 50%;\n  object-fit: cover;\n}\n.user-avatar-large {\n  width: 48px;\n  height: 48px;\n  border-radius: 50%;\n  object-fit: cover;\n}\n.user-info {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  padding: 16px;\n}\n.user-name {\n  font-weight: 600;\n  margin: 0;\n}\n.user-email {\n  font-size: 14px;\n  opacity: 0.7;\n  margin: 0;\n}\n.sidenav-container {\n  flex: 1;\n}\n.sidenav {\n  width: 280px;\n  padding: 0;\n}\n.sidenav mat-nav-list {\n  padding-top: 0;\n}\n.sidenav a.active {\n  background-color: rgba(0, 0, 0, 0.04);\n}\n.stat-badge {\n  background-color: #1976d2;\n  color: white;\n  padding: 4px 8px;\n  border-radius: 12px;\n  font-size: 12px;\n  font-weight: 600;\n}\n.main-content {\n  background-color: #fafafa;\n}\n.content-container {\n  padding: 24px;\n  max-width: 1200px;\n  margin: 0 auto;\n}\n.welcome-section {\n  margin-bottom: 32px;\n}\n.page-title {\n  font-size: 32px;\n  font-weight: 600;\n  margin: 0 0 8px 0;\n  color: #1976d2;\n}\n.page-subtitle {\n  font-size: 16px;\n  opacity: 0.7;\n  margin: 0;\n}\n.stats-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));\n  gap: 16px;\n  margin-bottom: 32px;\n}\n.stat-card {\n  border-radius: 12px;\n  transition: transform 0.2s, box-shadow 0.2s;\n}\n.stat-card:hover {\n  transform: translateY(-2px);\n  box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);\n}\n.stat-content {\n  display: flex;\n  align-items: center;\n  gap: 16px;\n}\n.stat-icon {\n  font-size: 40px;\n  width: 40px;\n  height: 40px;\n  border-radius: 8px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.stat-icon.primary {\n  background-color: #e3f2fd;\n  color: #1976d2;\n}\n.stat-icon.accent {\n  background-color: #fff3e0;\n  color: #f57c00;\n}\n.stat-icon.success {\n  background-color: #e8f5e8;\n  color: #4caf50;\n}\n.stat-icon.info {\n  background-color: #f3e5f5;\n  color: #9c27b0;\n}\n.stat-number {\n  font-size: 28px;\n  font-weight: 700;\n  margin: 0;\n  color: #333;\n}\n.stat-label {\n  font-size: 14px;\n  opacity: 0.7;\n  margin: 0;\n}\n.section-title {\n  font-size: 24px;\n  font-weight: 600;\n  margin: 0 0 16px 0;\n  color: #333;\n}\n.lists-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(300px, 1fr));\n  gap: 20px;\n}\n.list-card {\n  border-radius: 12px;\n  overflow: hidden;\n  transition: transform 0.2s, box-shadow 0.2s;\n  cursor: pointer;\n}\n.list-card:hover {\n  transform: translateY(-4px);\n  box-shadow: 0 8px 25px rgba(0, 0, 0, 0.15);\n}\n.list-image {\n  height: 160px;\n  background-size: cover;\n  background-position: center;\n  position: relative;\n}\n.list-overlay {\n  position: absolute;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  background: linear-gradient(transparent, rgba(0, 0, 0, 0.7));\n  color: white;\n  padding: 16px;\n}\n.list-title {\n  font-size: 18px;\n  font-weight: 600;\n  margin: 0;\n}\n.list-comment {\n  font-size: 14px;\n  opacity: 0.7;\n  margin: 0 0 12px 0;\n  line-height: 1.4;\n}\n.list-stats {\n  margin-bottom: 8px;\n}\n.list-stats mat-chip-set {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 4px;\n}\n.list-stats mat-chip {\n  font-size: 12px;\n}\n.no-lists {\n  text-align: center;\n  padding: 40px;\n  background-color: white;\n  border-radius: 12px;\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);\n}\n.empty-icon {\n  font-size: 64px;\n  width: 64px;\n  height: 64px;\n  opacity: 0.3;\n  margin-bottom: 16px;\n}\n.no-lists h3 {\n  margin: 0 0 8px 0;\n  font-size: 20px;\n}\n.no-lists p {\n  margin: 0 0 24px 0;\n  opacity: 0.7;\n}\n.loading-container {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  padding: 40px;\n  gap: 16px;\n}\n@media (max-width: 768px) {\n  .sidenav {\n    width: 240px;\n  }\n  .content-container {\n    padding: 16px;\n  }\n  .page-title {\n    font-size: 24px;\n  }\n  .stats-grid {\n    grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));\n    gap: 12px;\n  }\n  .lists-grid {\n    grid-template-columns: 1fr;\n    gap: 16px;\n  }\n}\n/*# sourceMappingURL=dashboard.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
//# sourceMappingURL=chunk-LURGZ7JU.js.map
